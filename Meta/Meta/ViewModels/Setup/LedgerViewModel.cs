...
namespace Meta.ViewModels.Setup
{
    public class LedgerViewModel : BindableBase, IPageViewModel
    {
        ...
        public ICommand CreateNewLedgerCommand => _createNewLedgerCommand ?? (_createNewLedgerCommand = new DelegateCommand(() => CreateLedger()));
        public ICommand ReconcileLedgerCommand => _reconcileLedgerCommand ?? (_reconcileLedgerCommand = new DelegateCommand(() => ReconcileLedger()));
        public Event Event => App.CurrentEvent;
        //TODO: Make dynamic.
        public Ledger Ledger { get { return _ledger; } set { SetProperty(ref _ledger, value); } }
